...
function get_bill_fields() {
	...
	for (var i = 1; i < trlist.length; i++) {
        ...
        if( part.id == "") {
            alert("入库的部件资料不全,请先添加该部件资料:" + part.name + "!");
            $(inputs[1]).focus();
            return;
        }
