...
<div id="wrap">  
  <div class="retail">  
    <div class="bill" id="bill" style="display:none">presale</div>
    <form id="salesform" name="salesform" action="#" method="post" class="formbox">
        ...
        <table class="headtab" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            ...
            <tr style="display:none">
              ...
              <td>
              	<div class="editbox w400">
                <input id="warehouse" name="warehouse" value="0" class="saleinput" type="text">
                </div>
              </td>
            </tr>            
          </tbody>
      ...
      <div class="billbutton">
        ...
        <div class="apply">
            <input id="save" name="save" value="保存当前价格单" class="submit" onclick="savebill();" tabindex="14" type="button">
            ...
            <input id="more" name="more" value="下一单" class="submit" onclick="newprice();" tabindex="15" type="button">
