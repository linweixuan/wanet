...
<table width="734" cellspacing="0" class="taiho" id="taiho">
  <tr class="headline" height="30">
    <td width="100" class="head blue-bottom ">型号</td>
    <td width="70" class="head">M/R</td>
    <td width="75" class="head">标准</td>
    <td width="75" class="head">加25</td>
    <td width="75" class="head">加50</td>
    <td width="75" class="head">加75</td>
    <td width="65" class="head">C</td>
    <td width="65" class="head">T</td>
    <td width="65" class="head">P</td>    
  </tr>
