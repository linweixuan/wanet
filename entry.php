...
<div id="wrap">
  <div class="retail">
    <div class="bill" id="bill" style="display:none">entry</div>
    <form id="salesform" name="salesform" action="#" method="post" class="formbox">
      ...
      <div class="billhead">
        <table class="headtab" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <th class="title" style="width: 60px">入库名称:</th>
      ...
      <div class="billbutton">
        ...
        <div class="apply">
            <input id="save" name="save" value="保存当前入库单" class="submit" onclick="savebill();" tabindex="14" type="button">
            ...
            <input id="more" name="more" value="下一单" class="submit" onclick="newentry();" tabindex="15" type="button">
