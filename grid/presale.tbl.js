...
var select_year = '';
var select_month = '';
var select_query = 'presale.tbl.php';
...
function set_datetime_active()
{
    ...
    select_query = 'presale.tbl.php?year='+year+'&month='+month;    
    select_year = year;
    select_month = month;
    ...
    for (var i=(year-1); i<=(year+1); i++) {
        ...
        jQuery(id).bind("click", function(){
            ...
            var query = 'presale.tbl.php?year='+select_year;
            set_grid_url(query);
            return false;
        });
    }    
    ...
    for (var i = 1; i <= 12; i++) {
        ...
        jQuery(id).bind("click", function(){
            ...
            select_month = select;            
            // set the grid query url
            var query = 'presale.tbl.php?year='+select_year+'&month='+select_month;
            set_grid_url(query);
            return false;
        });
    }    
...
function post_changes() {
    ...
    $("#tblobj").jqGrid('rowsave',
        id, { url: 'presale_save.php', reloadAfterSubmit:false}
    );
}
...
function post_delete() {
    ...
    $("#tblobj").jqGrid('delGridRow',
        id, { url: 'presale_delete.php', reloadAfterSubmit: false}
    );
}
...
$(document).ready(function () {
    ...
    $("#tblobj").jqGrid({
        ...
        sortorder: "asc",
        loadonce: false,
        editurl: "presale_save.php",
        ondblClickRow: function(rowid) {
            //$(this).jqGrid('editGridRow', rowid);        
            window.parent.add_presale_tab(rowid);
        }    
    });
