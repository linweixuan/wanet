...
<div id="wrap">
  <div class="retail">
    <div class="bill" id="bill" style="display:none">buy</div>
    <form id="salesform" name="salesform" action="#" method="post" class="formbox">
      ...
      <div class="billhead">
        <table class="headtab" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <th class="title" style="width: 70px">供应商名:</th>
              ...
              <td style="width: 100px">           
				<div class="iconbutton">
                    ...
                    <a id="tablink" class="tablink" href="company.html"><img src="images/edit1.jpeg" title="添加新供应商"/></a>
                    </span>
                </div>              
              </td>              
            ...
            <tr style="display:none">
              ...
              <td>
              	<div class="editbox w400">
                <input id="warehouse" name="warehouse" value="general" class="saleinput" type="text">
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <div class="billbutton">
        ...
        <div class="apply">
            <input id="save" name="save" value="入店库存" class="submit" onclick="warehouse();" tabindex="14" type="button">        
            <input id="save" name="save" value="保存(不入库)" class="submit" onclick="savebill();" tabindex="14" type="button">
            ...
            <input id="more" name="more" value="下一单" class="submit" onclick="newbuy();" tabindex="15" type="button">
