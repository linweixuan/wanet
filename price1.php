...
<div class="w" id="header">
  ...
  <div id="search" class="form">
    <form action="#" autocomplete="off">
      <div id="i-search">
        <input class="ac_input" id="key" value="" style="color: rgb(51, 51, 51);" autocomplete="off" type="text">
      </div>
      <input value="查询" id="query" onclick="search1('key');return false;" type="submit">
    </form>
  </div>
</div>
</body>
